...
class AlienInvasion:
	...
	def _check_bullet_alien_collisions(self):
		"""Response to bullet-alien collosions"""
		# Check for any bullets that have hid aliens.
	...
	def _update_aliens(self):
		"""
		Check if the flet is at the edge.
	...
	def _check_aliens_bottom(self):
		...
		for alien in self.aliens.sprites():
			if alien.rect.bottom >= screen_rect.bottom:
				# Treat this same as of the ship got hit
				self._ship_hit()
				break
